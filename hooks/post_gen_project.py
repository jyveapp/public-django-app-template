...
def temple_setup():
    ...
    print('Adding default collaborators to repo.')
    github_add_collaborators(
        REPO_NAME, JYVE_BACKEND_TEAM_ID, JYVE_BACKEND_TEAM_NAME, 'write'
    )
    ...
    get_user_input(
        'One final step! Go to'
        ' https://pullreminders.com/installs/13649329/'
        'notification_rules/9008/edit and scroll to the "Repositories"'
        f' field. Check "{REPO_NAME}" and click "Save Settings" so that'
        ' engineers will be reminded to review pull requests on this project.'
        ' Hit "return" after you have done this.'
    )
...
if __name__ == '__main__':
    ...
    if os.getenv(TEMPLE_ENV_VAR) == 'setup':
        prompt_msg = (
            f'Your Jyve Github repo name will be "{REPO_NAME}"'
